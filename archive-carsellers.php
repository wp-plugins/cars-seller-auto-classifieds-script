...
wp_register_style( 'carsellers', plugins_url( 'carsellers/css/style.css' ) );

wp_enqueue_style( 'carsellers' );
wp_register_style( 'check_availability', plugins_url('carsellers/css/check_availability.css') );
			...
			// die;
				...
				if ( has_post_thumbnail() ) { // check if the post has a Post Thumbnail assigned to it.
				  the_post_thumbnail();
					...
					echo '<img src="'.plugins_url('carsellers').'/images/no-image.png" title="';
					the_title();
					echo '">';
				} 
				echo '</a>';
				...
				<div class="carseller_title_location">
					...
					if(!empty($car_meta['car_our_price'][0]))
					{
							...
							echo '<div >&nbsp;&nbsp;<span class="pcd-price" style="color: #4a8ec9;font-size:21px;"><b>Price:</b> '.$currency_symbol['symbol'].'&nbsp;'.number_format($car_meta['car_our_price'][0],2).' </span></div>
								';
