...
function carseller_deactivation() {
    ...
    $messageforcustomer="
		...
		<tbody>
		<tr><td>
		Website named <b> ".site_url()." </b> has deactivated the carseller free 1.5 plugin.
		</td>
		</tr>
...
function car_sellers_archive_url(){
	return site_url('blog/carsellers');
}