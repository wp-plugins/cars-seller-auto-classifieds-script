...
If you are getting "The plugin does not have a valid header" error. 
Then please try to activate the plugin from "Plugins -> Installed Plugins".
Please feel free to write me if you have any queries.
