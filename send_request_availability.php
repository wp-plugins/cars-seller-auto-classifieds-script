...
function send_request_availability_carseller() {
	...
	// echo $formdata=unserialize($formdata);
...
[first name]
  ...
  $admin_email=get_option( 'admin_email');
	...
	wp_mail( $admin_email, 'The subject', $message, $headers );
	...
	wp_mail( $formdata['EmailAddress'], 'The subject', $messageforcustomer, $headers );	
	// print_r($formdata);
		echo '<h3 class="request_received">We have received your query and our team will contact you shortly.</h3>';
		
	}
	else
	{
		echo '<h3 class="request_denied">Oops! Something wrong, please try to contact us again .</h3>';
	}
	die;
}
